...
podman pull ghcr.io/fabiendupont/nvidia-bcm-lite-daemon:latest

# Or pull a specific version
podman pull ghcr.io/fabiendupont/nvidia-bcm-lite-daemon:v1.0.0
```
...
To build locally:
```bash
podman build -t ghcr.io/fabiendupont/nvidia-bcm-lite-daemon:latest .
```
...
# Or with Docker
docker build -t bcm-agent:latest .
